...
CLI entry point.  Run from the project root:
    ...
    python main.py
    python main.py --objective "Generate weekly sales report"
    python main.py --visualise   # prints the LangGraph Mermaid diagram
"""
import argparse
import json
import logging
...
def main() -> None:
    ...
    print(f"  FILES   : {final_state.get('files_created', [])}")
